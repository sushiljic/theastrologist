...
public class CalcUtil {
	...
	public static Degree calculatePartDeFortune(Degree sunDegree, Degree moonDegree) {
		double partDegree = (moonDegree.getBaseDegree() + sunDegree.getBaseDegree()) / 2;

		if (partDegree < 0) {
			partDegree += 180;
		} else if (partDegree >= 180) {
			partDegree -= 180;
		}
